...
class EmbeddingModel:
    ...
    def get_each_encoding_layer_output_with_first_layer_noise(self, text, noise_level=0.1):
...
if __name__ == "__main__":
    ...
    for text in all_texts:
        ...
        for i in range(num_aug):
            embs.append(embedder.get_each_encoding_layer_output_with_first_layer_noise(text, noise_level=noise_level))
    embs = torch.cat(embs)
